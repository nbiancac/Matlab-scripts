...
% characteristics and the xy parameter widens the traceID box and
% moves the plotting axis to make room for this.
...
p        = [0 .159 .120 .762 .870;  % position: plotting area
           -1 .006 .433 .117 .110]; % position: TraceID box
plt(x,[square; sawtooth; triangle; sweep; serp],'Right',2,...
   ...
   'SubPlot',[50 30 20],'FigBKc',1./[9 12 9],'xy',p,...
