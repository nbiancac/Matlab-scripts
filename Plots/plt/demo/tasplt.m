...
plt(gph,mpg,...
    ...
    'LabelX','Fuel flow (gph)','xy',[.11 .09 .825 .838],...
    'LabelY','Nautical miles per gallon','TraceID',traceID,...
    'Pos',[10 45 wid hi],'Options','S-X-Y','AxisCB',[tg ys yt xs]);
...
plt(gph,tas,'Pos',[sz(3)-wid-10 sz(4)-hi-80 wid hi],'Options','S-X-Y',...
...
set([text(0,0,'gph  =  \sigma p V^3  +   i  /  \sigma V'); % Add plot anotation
     ...
     {'fontsize'},{13; 9; 12; 12; 12},'color',[1 1 .2],'units','norm',...
