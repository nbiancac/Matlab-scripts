...
% to find the cursor. The last line of this script solves this problem by both
% increasing the cursor size from 8 to 20 and by changing the cursor shape from
% a plus sign to an asterisk.
...
plt(t,y,'FigName','plt50','Pos',[10 50 830 550],'TIDcolumn',25,...
        'HelpFileR','prin.pdf','CloseReq','disp("plt50 has finished")');
set(findobj(gcf,'markersize',8),'markersize',20,'marker','*');