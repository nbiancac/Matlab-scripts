% plt.m:   An alternative to plot and plotyy (version 13Mar15)
...
% plt(...,'xy',p)         : Modify plot axis, TraceID box, or MenuBox positions
...
%                           'xView'         enables the xView slider
...
%                           'multiCur'      enables the multiCursor
...
% plt(...,'CloseReq',s)   : s is a string, function handle, or cell array which is executed
%                           when plt is terminated.
...
% plt move               ; toggles object move status
...
% plt('show',e)          : e = list of trace #'s to enable. All others are disabled.
% plt('show')            : returns a list of enabled trace trace numbers.
