function Zinterp=vmarker1(Z,Freq,Zo,Markers,Mnumber)
% VSWR Marker
%
% Draws a single marker on VSWR chart at frequency specified
% by Marker. Returning the interpolated Z value. It allows 
% individual markers to be applied to different impedance plots.
%
% Usage: Zinterp=vmarker1(Z,Freq,Zo,Marker,Mnumber)
%
...
%
% e.g. vswrc(Z,Freq,Zo);
%      Vmarker1(Z,Freq,Zo,880,1)
%      Vmarker1(Zin,Freq,Zo,880,2)
%
