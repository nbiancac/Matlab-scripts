...
Z=(10+8*j);        % Single value load impedance

% Generate a realistic imedance locii for Zload by transforming
% Z through a short section of transmission line of slightly different
% impedance to the single value Z. The single value Z is vectorised 
% by trl.m over the range of frequencies in Freq.
Zload=trl((Z+2+2*j),Z,600,Freq,1,0); 
