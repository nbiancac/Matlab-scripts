...
% e.g. C:\matlab\toolbox\rfutils\examples\data01.d1
...
% Installation independent call of citi1.m
filename = which('example5');
pathstr = fileparts(filename);

citifile = 'data01.d1';
[Z1,Freq]=citi1(strcat(pathstr, filesep, citifile));

citifile = 'data02.d1';
[Z2,Freq]=citi1(strcat(pathstr, filesep, citifile));

citifile = 'data03.d1';
[Z3,Freq]=citi1(strcat(pathstr, filesep, citifile));

% Old version with hard coded filename
%[Z1,Freq]=citi1('C:\matlab\toolbox\rfutils\examples\data01.d1');
%[Z2,Freq]=citi1('C:\matlab\toolbox\rfutils\examples\data02.d1');
%[Z3,Freq]=citi1('C:\matlab\toolbox\rfutils\examples\data03.d1');
